      ...
      <div className="ll-root min-h-screen bg-white">
        ...
        <header className="sticky top-0 z-50 backdrop-blur-md bg-white/80 border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <Logo size={36} />
              <span className="text-xl" style={{ color: '#2F4F4F', fontWeight: 700 }}>LectureLink</span>
            </div>
          ...
          {menuOpen && (
            <div className="md:hidden bg-white border-t border-gray-100">
              <div className="px-6 py-4 flex flex-col gap-4">
                ...
                <button className="w-full py-2.5 rounded-full text-sm text-white" style={{ backgroundColor: '#2F4F4F', fontWeight: 700 }}>시작하기</button>
              </div>
            </div>
          )}
        </header>
        ...
        <section className="relative overflow-hidden bg-white">
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            {bgLogos.map((lg, i) => (
              <div key={i} className="absolute" style={{ top: lg.top, ...(lg.left ? { left: lg.left } : {}), ...(lg.right ? { right: lg.right } : {}), opacity: lg.opacity, transform: `rotate(${lg.rotate}deg)` }}>
                <Logo size={lg.size} />
              </div>
            ))}
          </div>
          <div className="relative max-w-3xl mx-auto px-6 pt-20 pb-24">
            <div className="flex flex-col items-center justify-center gap-8 mb-12">
              <div className="flex items-center gap-2 px-4 py-1.5 rounded-full border" style={{ backgroundColor: '#F5F9F8', borderColor: '#8CBDB3' }}>
                ...
                <span className="text-xs" style={{ color: '#2F4F4F', fontWeight: 700 }}>베타 테스트 진행 중</span>
              </div>
            ...
            <div className="max-w-xl mx-auto">
              ...
              <div className="relative group mb-3">
                ...
                <div className="relative bg-white rounded-full shadow-md border border-gray-100 flex items-center pl-7 pr-5 py-1.5 transition focus-within:border-[#8CBDB3] focus-within:shadow-lg">
                  ...
                  <button
                    ...
                    style={{ color: '#FFFFFF', backgroundColor: termsAgreed ? '#E67E22' : '#D3D9D4' }}
                  >
              ...
              <button className="w-full bg-white border-2 border-dashed rounded-3xl p-5 flex items-center gap-4 hover:border-[#8CBDB3] hover:bg-[#F5F9F8] transition group text-left" style={{ borderColor: '#D3D9D4' }}>
                ...
                <div className="flex-1">
                  <div className="text-sm mb-1" style={{ color: '#2F4F4F', fontWeight: 700 }}>내 강의록 업로드하고 분석하기</div>
              ...
              <div className="mb-3">
                <div className="flex items-center gap-1.5 mb-2 px-1">
                  ...
                  <span className="text-[11px]" style={{ color: '#2F4F4F', opacity: 0.7, fontWeight: 700, letterSpacing: '0.02em' }}>이용약관 · 반드시 확인해주세요</span>
                </div>
                <div className="terms-scroll overflow-y-auto h-56 p-5 rounded-2xl border text-xs leading-relaxed" style={{ backgroundColor: '#F7F8F7', borderColor: '#E5EAE8', color: '#2F4F4F' }}>
                  <div className="mb-1" style={{ fontWeight: 700, fontSize: '13px' }}>[LectureLink] 베타 서비스 이용약관</div>
                  <div className="text-[10px] mb-4 pb-3 border-b" style={{ opacity: 0.65, fontWeight: 500, borderColor: '#E5EAE8' }}>시행일: 2026년 5월 4일 · 베타 기간 한정 적용</div>
                  ...
                  <div className="rounded-xl p-3 mb-3 flex gap-2 items-start" style={{ backgroundColor: '#FFF4E6', border: '1px solid #F5D1A9' }}>
                    ...
                    <div className="text-[11px] leading-relaxed" style={{ color: '#2F4F4F', fontWeight: 500 }}>
                      서비스 내 자료를 무단으로 외부에 유출할 경우, 저작권법 제136조에 따라{' '}
                      <span style={{ fontWeight: 700, color: '#E67E22' }}>5년 이하의 징역 또는 5천만 원 이하의 벌금</span>에 처해질 수 있습니다.
                    </div>
                  </div>
              ...
              <label className="flex items-start gap-3 cursor-pointer group select-none p-3 rounded-2xl transition hover:bg-gray-50">
                <div className="flex-shrink-0 mt-0.5">
                  <input type="checkbox" checked={termsAgreed} onChange={(e) => setTermsAgreed(e.target.checked)} className="sr-only" />
                  <div className="w-5 h-5 rounded-md border-2 flex items-center justify-center transition" style={{ backgroundColor: termsAgreed ? '#E67E22' : '#FFFFFF', borderColor: termsAgreed ? '#E67E22' : '#C9D1CD' }}>
              ...
              {!termsAgreed && (
                <div className="mt-3 text-center">
                  <span className="text-[11px]" style={{ color: '#9CA3AF', fontWeight: 500 }}>약관에 동의하시면 검색 버튼이 활성화됩니다</span>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="relative p-7 rounded-3xl border-2 bg-white hover:shadow-xl hover:-translate-y-1 transition overflow-hidden" style={{ borderColor: '#E67E22' }}>
                ...
                <div className="relative">
                  ...
                  <div className="flex items-baseline gap-1 mb-3">
                    <span className="text-5xl md:text-6xl num-tabular" style={{ color: '#E67E22' }}>{uploadCount.toLocaleString()}</span>
                  ...
                  <div className="text-xs" style={{ color: '#2F4F4F', opacity: 0.55 }}>베타 참여자와 함께 계속 늘어나는 중</div>
                </div>
              </div>
              ...
              {[
                ...
                <div key={i} className="relative p-7 rounded-3xl border border-gray-100 bg-white hover:shadow-md hover:-translate-y-1 transition">
                  ...
                  <div className="text-xs" style={{ color: '#2F4F4F', opacity: 0.55 }}>{stat.desc}</div>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="bg-white rounded-3xl p-8 transition hover:shadow-xl hover:-translate-y-1 border border-gray-100">
                  ...
                  <h3 className="text-xl mb-3 leading-snug whitespace-pre-line" style={{ color: '#2F4F4F' }}>{feat.title}</h3>
                  <p className="text-sm mb-6" style={{ color: '#2F4F4F', opacity: 0.7, fontWeight: 400 }}>{feat.desc}</p>
        ...
        <section id="how" className="max-w-7xl mx-auto px-6 py-20">
          <div className="bg-white rounded-3xl p-10 md:p-16 border border-gray-100 shadow-sm">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl mb-4" style={{ color: '#2F4F4F' }}>복잡한 과정, 단 3단계</h2>
              <p className="text-base" style={{ color: '#2F4F4F', opacity: 0.7, fontWeight: 500 }}>업로드부터 맞춤 학습까지 1분이면 충분합니다.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="relative">
                  ...
                  <p className="text-sm" style={{ color: '#2F4F4F', opacity: 0.7, fontWeight: 400 }}>{step.desc}</p>
                  {i < 2 && <ChevronRight className="hidden md:block absolute -right-4 top-16" size={20} style={{ color: '#8CBDB3' }} />}
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-6 py-20">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="rounded-3xl p-10 text-white relative overflow-hidden" style={{ backgroundColor: '#2F4F4F' }}>
              ...
              <p className="text-sm opacity-80 mb-6" style={{ fontWeight: 400 }}>의료 도메인 인덱싱 엔진으로 불필요한 연산을 줄여, 같은 품질을 더 빠르게 제공합니다.</p>
            ...
            <div className="rounded-3xl p-10 bg-white border border-gray-100 shadow-sm relative overflow-hidden">
              ...
              <p className="text-sm mb-6 relative" style={{ color: '#2F4F4F', opacity: 0.7, fontWeight: 400 }}>업로드된 강의록은 암호화 저장되며, 외부 모델 학습에 사용되지 않습니다.</p>
        ...
        <section id="pricing" className="max-w-5xl mx-auto px-6 py-20">
          <div className="rounded-[2.5rem] p-12 md:p-16 text-center relative overflow-hidden" style={{ backgroundColor: '#8CBDB3' }}>
            ...
            <div className="relative">
              ...
              <h2 className="text-3xl md:text-4xl text-white mb-5">오늘 밤, 더 효율적으로 공부하세요</h2>
